...
import math, random, datetime, re, csv
from probability import inverse_normal_cdf
import matplotlib.pyplot as plt
from statistics_ds import correlation, standard_deviation
from linear_algebra import Matrix, Vector, make_matrix, distance, vector_mean, subtract, dot, magnitude, scalar_multiply
...
with open("src/inputs/stocks.csv", "r") as f:
